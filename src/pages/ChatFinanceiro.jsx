...
import {
  ...
  CalendarRange, Receipt, ArrowUpRight, MessageSquare,
} from "lucide-react";
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="card p-5">
            ...
            <div className="space-y-2">
              ...
              <QuickAction icon={Receipt}       title="Situação de IVA"       description="Verifique IVA a pagar ou receber"   onClick={() => setInput("Tenho IVA a pagar ou a receber?")} />
            </div>
          </div>
