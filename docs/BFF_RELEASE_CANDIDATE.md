...
| **R-B** | **ABERTO — aceite temporariamente** | O *Protection Bypass for Automation* ainda existe. Foi aceite para permitir o smoke, que **já terminou**. É o primeiro passo da próxima sessão de desktop, e é **anterior** a qualquer decisão de promoção. |
